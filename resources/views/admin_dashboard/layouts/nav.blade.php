...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{ url('ecommerce-orders') }}"><i class="bx bx-right-arrow-alt"></i>All Articles</a>
                </li>
                <li>
                    <a href="{{ url('ecommerce-add-new-products') }}"><i class="bx bx-right-arrow-alt"></i>Add New Article</a>
                </li>
            </ul>
        </li>
